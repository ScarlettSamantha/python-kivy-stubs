...
class KNSpace(EventDispatcher):
    ...
    __has_applied = ...
    keep_ref = ...
    def __init__(self, parent=..., keep_ref=..., **kwargs) -> None:
        ...
    ...
    def property(self, name, quiet=...): # -> ObjectProperty[Any]:
        ...
    
    def fork(self): # -> KNSpace:
...
class KNSpaceBehavior:
    ...
    __last_knspace = ...
    __callbacks = ...
    def __init__(self, knspace=..., **kwargs) -> None:
        ...
